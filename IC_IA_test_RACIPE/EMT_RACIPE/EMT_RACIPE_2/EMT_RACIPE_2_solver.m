...
prs_file = 'EMT_RACIPE_2.prs';
prs_new = 'EMT_RACIPE_2.dat';
...
par_file = 'EMT_RACIPE_2_parameters.dat';
...
parfor i = 1:size(parameters,1)
    ...
    for j = 1:100
        ...
        y0 = IC;
        [t y] = ode23s(@(t,y)EMT_RACIPE_2(t,y,p), tspan, y0);
        for k = 1:50
...
writetable(ss_tot, 'EMT_RACIPE_2_ss_1000.csv');
